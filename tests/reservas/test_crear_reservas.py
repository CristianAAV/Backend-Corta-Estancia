...
from modelos import Usuario, Propiedad, Banco, Movimiento, TipoMovimiento, Categoria, ReservaSchema, db, TipoUsuario
...
class TestCrearReservas:
    ...
    def test_crear_reserva_crea_movimiento_ingreso(self, client):
        ...
        assert movimiento_ingreso.categoria == Categoria.INGRESOS_POR_RESERVAS
    ...
    def test_crear_reserva_crea_movimiento_egreso(self, client):
        ...
        assert movimiento_egreso.categoria == Categoria.EGRESOS_POR_PLATAFORMA
