...
class TestObtenerMantenimientos:
    ...
    def test_retorna_lista_vacia_si_propiedad_no_tiene_mantenimientos(self, client):
        token_usuario_1 = create_access_token(identity=self.usuario_1.id)
    ...
    def test_retorna_mantenimientos_de_propiedad(self, client):
        ...
        assert mantenimiento_schema.dump(self.mantenimiento_piscina) in self.respuesta_json
        assert mantenimiento_schema.dump(self.mantenimiento_reserva) in self.respuesta_json
