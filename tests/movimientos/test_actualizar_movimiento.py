...
class TestActualizarMovimiento:
    ...
    def test_retorna_400_actualizar_movimiento_categoria_reseva(self, client, mock_datetime_now):
    ...
    def test_retorna_200_actualizar_movimiento_categoria_comision(self, client, mock_datetime_now):
