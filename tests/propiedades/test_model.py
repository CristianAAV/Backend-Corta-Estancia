...
class TestModeloPropiedades(TestCase):
    ...
    def setUp(self):
        self.usuario = Usuario(usuario="usuario_test", contrasena='123456', tipo_usuario=TipoUsuario.ADMINISTRADOR.value)
    ...
    def test_registro_con_info_correcta_es_creado(self):
        ...
        self.assertEqual(propiedad_db.id_propietario, 1)
