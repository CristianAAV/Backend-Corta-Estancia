...
class TestActualizarPropiedad:
    ...
    def test_retorna_200_al_actualizar_propiedad(self, client):
        ...
        self.actuar(
            {
                'nombre_propiedad': 'nombre propiedad actualizado 1',
                'direccion': 'nueva direccion propiedad 1'
            },
    ...
    def test_retorna_401_no_token(self, client):
        self.actuar(
            {
                'nombre_propiedad': 'nombre propiedad actualizado 2',
                'direccion': 'nueva direccion propiedad 2'
            },
            self.propiedad_1_usu_1.id,
            client,
        )
    ...
    def test_actualiza_solo_campos_enviados(self, client):
        ...
        self.actuar(
            {
                'nombre_propiedad': 'nombre propiedad actualizado 3',
                'direccion': 'nueva direccion propiedad 3'
            },
            self.propiedad_1_usu_1.id,
            client,
            token_usuario_1
        ...
        assert propiedad_db.nombre_propiedad == 'nombre propiedad actualizado 3'
        assert propiedad_db.direccion == 'nueva direccion propiedad 3'
    ...
    def test_retorna_404_si_propiedad_no_es_del_usuario(self, client):
        ...
        self.actuar(
            {
                'nombre_propiedad': 'nombre propiedad actualizado 5',
                'direccion': 'nueva direccion propiedad 5'
            },
            self.propiedad_1_usu_1.id,
            client,
            token_usuario_2
